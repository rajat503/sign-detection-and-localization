...
h_pool12 = max_pool_2x2(h_pool11)
h_pool1 = max_pool_2x2(h_pool12)
...
h_pool51 = max_pool_2x2(h_conv5)
h_pool5 = max_pool_2x2(h_pool51)


h_pool5_flat = tf.reshape(h_pool5, [-1, 5*4*32])
